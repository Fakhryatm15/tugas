...
class AdapterBiodata(private val mList: List<Detail>) : RecyclerView.Adapter<AdapterBiodata.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.nim.text = ItemsViewModel.nim
        holder.hobi.text = ItemsViewModel.hobi
